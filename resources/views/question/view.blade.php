		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					<h6 class="m-0 font-weight-bold text-primary">View Question</h6>
				</div>
				<div class="card-body">
					<div class="row">
						<div class="col-md-12">
					...
					<a href="{{ route ('edit-question') }}" class="btn btn-warning">Update</a>
					<a href="" class="btn btn-danger" data-toggle="modal" data-target="#deleteModal">Delete</a>
					<a href="{{ route ('question') }}" class="btn btn-info">Back</a>
