                            ...
                            <div class="col-md-12">
                                <form>
                                    ...
                                    <div class="form-group">
                                        <label>Answer</label>
                                        <textarea class="form-control form-control-user" rows="6" placeholder="Answer"></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label>Question</label><br>
                                        <textarea class="form-control form-control-user" rows="6" placeholder="Question"></textarea>
                                    </div>
